...
abstract class Filename_Shema_Installation_Date implements I_Filename_Shema {
  ...
  public static function print_filename_shema_input_for_ui(int $index) : void {
    printf(self::input_shema_template, $index, Ui::ui_data_key_root, (new DateTime())->format('Y-m-d'), Filename_Shema_Installation_Date::class);
  }


  # print filename shema search input to ui
  public static function print_filename_shema_search_input_for_ui(int $index) : void {
    printf(self::input_shema_template, $index, Ui::ui_search_data_key_root, (new DateTime())->format('Y-m-d'), Filename_Shema_Installation_Date::class);
  }
