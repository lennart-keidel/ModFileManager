...
abstract class Sub_Data_Categorie_Pattern_Categorie extends Compareable_Is_Operand implements I_Filename_Shema {
  ...
  private const array_option_id = [
    ...
    "option_woods" => "WO",
    "option_metals" => "ME",
    "option_weave_and_wicker" => "WE",
    "option_paint" => "PA",
    "option_tiles_and_mosaic" => "TI",
    "option_plastic_and_rubber" => "PL",
    "option_rock_and_stone" => "RO",
    "option_masonry" => "MA",
    "option_misc" => "MI",
  ];
  ...
  <div class="container_label_and_input sub_input option_pattern_sub_data_categorie%1$d">
    <label for="%3$s%1$d">Pattern-Kategorie</label>
    <select class="%3$s%1$d option_pattern_sub_data_categorie%1$d" name="%2$s[%1$d]['.self::class.']" id="%3$s%1$d" %4$s>
      <option value="" selected disabled>Auswählen</option>
      <option value="option_fabrics">Fabrics</option>
      <option value="option_leather_and_furs">Leather & Furs</option>
      <option value="option_carpeting_and_rugs">Carpeting & Rugs</option>
      <option value="option_abstract">Abstract</option>
      <option value="option_geometric">Geometric</option>
      <option value="option_themed">Themed</option>
      <option value="option_woods">Woods</option>
      <option value="option_metals">Metals</option>
      <option value="option_weave_and_wicker">Weave & Wicker</option>
      <option value="option_paint">Paint</option>
      <option value="option_tiles_and_mosaic">Tiles & Mosaic</option>
      <option value="option_plastic_and_rubber">Plastic & Rubber</option>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function(){
        setTimeout(function(){
          disable_and_hide_input_by_class_name_if_source_element_is_not_selected(\''.Filename_Shema_Categorie::class.'%1$d\', \'option_pattern\', \'option_pattern_sub_data_categorie%1$d\');
        },100);
      });
    </script>
  </div>
  ...
  <div class="container_label_and_input sub_input option_pattern_sub_data_categorie%1$d">
    ...
    <select class="%3$s%1$d option_pattern_sub_data_categorie%1$d" name="%2$s[%1$d]['.Ui::ui_search_data_key_value_root.']['.self::class.'][]" id="%3$s%1$d" required>
      <option value="" selected disabled>Auswählen</option>
      <option value="option_fabrics">Fabrics</option>
      <option value="option_leather_and_furs">Leather & Furs</option>
      <option value="option_carpeting_and_rugs">Carpeting & Rugs</option>
