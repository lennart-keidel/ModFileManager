...
abstract class Session_Cookie_Handler
{
  ...
  public static function store_duplicate_file_check_input_in_file(array $ui_data): void
  {
    ...
    if (!file_exists("src/Duplicate_File_Check/duplicate_file_check_paths.txt")) {
      file_put_contents("src/Duplicate_File_Check/duplicate_file_check_paths.txt", "C:\Users\U\Documents\Electronic Arts\CC Magic\Content\Packages
C:\Users\U\Documents\Electronic Arts\CC Magic\Content\Sims3Packs
C:\Users\U\Documents\Electronic Arts\CC Magic\Content\Store Sims3Packs
C:\Users\U\Documents\Electronic Arts\CC Magic\Content\Corrupt
C:\Users\U\Documents\Electronic Arts\CC Magic\Content\Archives
C:\Users\U\Documents\Electronic Arts\The Sims 3\Mods\Packages
C:\Users\U\Documents\Electronic Arts\The Sims 3\Mods\Overrides
C:\Users\U\Documents\Electronic Arts\The Sims 3\Mods\Disabled
C:\Users\U\Documents\Electronic Arts\The Sims 3\Downloads
C:\Users\U\Documents\Electronic Arts\The Sims 3\Library
C:\Users\U\Documents\Electronic Arts\The Sims 3\SavedSims");
    }

    # if source path key exists in ui data
    # set expire date: now + 1 month
    if (isset($ui_data[Ui::ui_key_duplicate_file_check_root_key][Ui::ui_key_duplicate_file_check_file_list_input]) === true) {
      file_put_contents("src/Duplicate_File_Check/duplicate_file_check_paths.txt", $ui_data[Ui::ui_key_duplicate_file_check_root_key][Ui::ui_key_duplicate_file_check_file_list_input]);
